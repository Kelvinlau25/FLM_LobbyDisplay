...
Public Class HtmlStriper
    ...
    Public Shared Function ToText(ByVal source As String) As String
        Try
    ...
    Public Shared Function FSMaskUrlDecode(ByVal RawUrl As String) As String
        Return HttpUtility.UrlDecode(RawUrl).Replace(ConfigurationManager.AppSettings.Get("FILESERVER_KEY").ToString, ConfigurationManager.AppSettings.Get("FILESERVER_URL").ToString).Trim()
    End Function

    Public Shared Function MMaskFLVPlayerDecode(ByVal RawHtml As String) As String
        Return HttpUtility.HtmlDecode(RawHtml).Replace(ConfigurationManager.AppSettings.Get("FLVPLAYER_KEY").ToString, ConfigurationManager.AppSettings.Get("FLVPLAYER_URL").ToString).Replace(ConfigurationManager.AppSettings.Get("FILESERVER_KEY").ToString, ConfigurationManager.AppSettings.Get("FILESERVER_URL").ToString).Trim()
    End Function
