...
public class FullMainScreenDtlModel : PageModel
{
    ...
    public async Task<IActionResult> OnGetAsync()
    {
        ...
        if (Action == 3) // Edit
        {
            MainTitle = "Master Maintenance Main Screen Video - Pantry - Edit";
        ...
        {
            MainTitle = "Master Maintenance Main Screen Video - Pantry - Add";
        }
        return Page();
    }
    ...
    public async Task<IActionResult> OnPostAsync()
    {
        ...
        try
        {
            ...
            if (Action == 1) // Add
            {
                ...
                var savePath = Path.Combine(_env.WebRootPath, "acc", "PantryDisplay", "mainscr", name);
                ...
                cmd.Parameters.Add(new SqlParameter("@scrId", SqlDbType.VarChar) { Value = "4" });
