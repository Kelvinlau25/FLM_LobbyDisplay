...
public class Lower2ndScreenDtlModel : PageModel
{
    ...
    public async Task<IActionResult> OnGetAsync()
    {
        ...
        if (Action == 3) // Edit
        {
            MainTitle = "Master Maintenance Second Screen Lower Video - Pantry - Edit";
        ...
        {
            MainTitle = "Master Maintenance Second Screen Lower Video - Pantry - Add";
        }
        return Page();
    }
    ...
    public async Task<IActionResult> OnPostAsync()
    {
        ...
        try
        {
            ...
            if (Action == 1) // Add
            {
                ...
                var savePath = Path.Combine(_env.WebRootPath, "acc", "PantryDisplay", "secscrbtm", name);
                ...
                cmd.Parameters.Add(new SqlParameter("@scrId", SqlDbType.VarChar) { Value = "6" });
