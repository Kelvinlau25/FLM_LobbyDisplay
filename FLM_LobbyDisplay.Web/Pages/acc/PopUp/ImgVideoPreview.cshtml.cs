...
namespace FLM_LobbyDisplay.Pages.acc.PopUp;
...
public class ImgVideoPreviewModel : PageModel
{
    ...
    public void OnGet()
    {
        ...
        if (ext is "mp4" or "wmv")
        {
            ...
            {
                "1" => $"{baseUrl}/acc/LobbyDisplay/mainscr/{file}",
                "2" => $"{baseUrl}/acc/LobbyDisplay/secscrtop/{file}",
                _   => $"{baseUrl}/acc/LobbyDisplay/secscrbtm/{file}"
            };
        }
    }
}
