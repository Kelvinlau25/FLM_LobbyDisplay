...
namespace FLM_LobbyDisplay.Pages.acc.PopUpPan;
...
public class ImgVideoPreviewModel : PageModel
{
    ...
    public void OnGet()
    {
        ...
        if (ext is "mp4" or "wmv")
        {
            ...
            {
                "1" => $"{baseUrl}/acc/PantryDisplay/mainscr/{file}",
                "2" => $"{baseUrl}/acc/PantryDisplay/secscrtop/{file}",
                _   => $"{baseUrl}/acc/PantryDisplay/secscrbtm/{file}"
            };
        }
    }
}
