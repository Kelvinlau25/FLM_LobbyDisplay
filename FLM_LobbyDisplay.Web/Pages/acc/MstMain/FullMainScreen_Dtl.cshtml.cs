...
namespace FLM_LobbyDisplay.Pages.acc.MstMain;

public class FullMainScreenDtlModel : PageModel
{
    private readonly IConfiguration _config;
    private readonly IWebHostEnvironment _env;
    private readonly ILogger<FullMainScreenDtlModel> _logger;
    ...
    public FullMainScreenDtlModel(IConfiguration config, IWebHostEnvironment env, ILogger<FullMainScreenDtlModel> logger)
    {
        _config = config;
        _env = env;
        _logger = logger;
    ...
    public async Task<IActionResult> OnGetAsync()
    {
        ...
        if (Action == 3) // Edit
        {
            MainTitle = "Master Maintenance Main Screen Video - Edit";
        ...
        {
            MainTitle = "Master Maintenance Main Screen Video - Add";
        }
        return Page();
    }
    ...
    public async Task<IActionResult> OnPostAsync()
    {
        ...
        try
        {
            ...
            if (Action == 1) // Add
            {
                ...
                var savePath = Path.Combine(_env.WebRootPath, "acc", "LobbyDisplay", "mainscr", name);
                ...
                cmd.Parameters.Add(new SqlParameter("@scrId", SqlDbType.VarChar) { Value = "1" });
                ...
                return Redirect(Url.Content("~/acc/MstMain/MM_VerticalScreenFull"));
            }
