...
public class Lower2ndScreenDtlModel : PageModel
{
    ...
    public async Task<IActionResult> OnGetAsync()
    {
        ...
        if (Action == 3) // Edit
        {
            MainTitle = "Master Maintenance Second Screen Lower Video - Edit";
        ...
        {
            MainTitle = "Master Maintenance Second Screen Lower Video - Add";
        }
        return Page();
    }
    ...
    public async Task<IActionResult> OnPostAsync()
    {
        ...
        try
        {
            ...
            if (Action == 1) // Add
            {
                ...
                var savePath = Path.Combine(_env.WebRootPath, "acc", "LobbyDisplay", "secscrbtm", name);
                ...
                cmd.Parameters.Add(new SqlParameter("@scrId", SqlDbType.VarChar) { Value = "3" });
