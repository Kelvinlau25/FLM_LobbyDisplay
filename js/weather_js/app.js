(function ($, window, document, undefined) {
	...
	$.extend(Plugin.prototype, {
		...
		_renderCheckBox: function() {
			$(this.element).find('.weather__checkbox').attr('src', `../../image/weather_img/dialog_checkbox${this.settings.fixLocation ? '_selected' : ''}.png`);
		},
		...
		_render: function(obj) {
			...
			if (obj) {
				...
				<div class="wbox"><img class="weather__checkbox" title="Fix this city" src="../../image/weather_img/dialog_checkbox${this.settings.fixLocation ? '_selected' : ''}.png">
				<span class="weather__name-city" title="Click to select another city">${obj.name}, ${obj.country}</span></div><br>
				<div class="weather__wrapper">
				<img class="weather__img" title="${obj.description}" src="../../image/weather_img/${this._icons[obj.icon]}.png"><br>
				...
				.css(`background`, `url("../../image/weather_img/${obj.icon}.jpg")`)
				.css(`background`, `url("../../image/weather_img/${obj.icon}.jpg")`)
