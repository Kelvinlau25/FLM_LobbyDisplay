...
public partial class acc_LobbyDisplay2_lobby_2ndDisplay : System.Web.UI.Page
{
    ...
    {
        string sql = "SELECT * FROM MM_VIDEOS WHERE RECORD_TYP<>5 AND SCR_ID=8";
        ...
        string sql2 = "SELECT * FROM MM_VIDEOS WHERE RECORD_TYP<>5 AND SCR_ID=9";
        ...
        string path1 = "\\acc\\LobbyDisplay2\\secscrtop\\";
        string path2 = "\\acc\\LobbyDisplay2\\secscrbtm\\";
        ...
        try
        {
            string TextPath = Server.MapPath("..\\MstMainLobby2\\scrollingtext.txt");
