...
Partial Class Acc_LobbyDisplay_lobby_mainDisplay
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		...
		Dim sql As String = "SELECT * FROM MM_VIDEOS WHERE RECORD_TYP<>5 AND SCR_ID=1"
        Dim dt As New DataTable
        If Not db_connSQLSel(sql, dt) Then
            Exit Sub
        End If
		
		Dim path1 As String = "\acc\LobbyDisplay\mainscr\"
        Dim videocount As Integer = 0 'add new by zikri to count
		...
		Try    
			Dim TextPath as String = Server.MapPath("..\MstMain\scrollingtext.txt")		
		...
		If IsPostBack Then
            ...
            ScriptManager.RegisterClientScriptBlock(Me, [GetType](), "Javascript", "loaded(""" + video_lists_tr + """, """ + seek_starts_tr + """, """ + seek_ends_tr + """, """ + period_starts_tr + """, """ + period_ends_tr + """);onPageLoad();", True)
        Else
