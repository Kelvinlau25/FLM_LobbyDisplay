...
Partial Class acc_LobbyDisplay_lobby_2ndDisplay
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
	    ...
	    Dim sql As String = "SELECT * FROM MM_VIDEOS WHERE RECORD_TYP<>5 AND SCR_ID=2"
        Dim dt As New DataTable
        If Not db_connSQLSel(sql, dt) Then
            Exit Sub
        End If

        Dim sql2 As String = "SELECT * FROM MM_VIDEOS WHERE RECORD_TYP<>5 AND SCR_ID=3"
        Dim dt2 As New DataTable
        If Not db_connSQLSel(sql2, dt2) Then
            Exit Sub
        End If

        Dim path1 As String = "\acc\LobbyDisplay\secscrtop\"
        Dim path2 As String = "\acc\LobbyDisplay\secscrbtm\"
