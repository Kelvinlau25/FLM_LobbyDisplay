...
public partial class Acc_LobbyDisplay_lobby_mainDisplay : System.Web.UI.Page
{
    ...
    {
        string sql = "SELECT * FROM MM_VIDEOS WHERE RECORD_TYP<>5 AND SCR_ID=1";
        ...
        string path1 = "\\acc\\LobbyDisplay\\mainscr\\";
