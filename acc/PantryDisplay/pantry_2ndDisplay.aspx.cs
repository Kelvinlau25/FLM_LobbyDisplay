...
public partial class acc_PantryDisplay_pantry_2ndDisplay : System.Web.UI.Page
{
    ...
    {
        string sql = "SELECT * FROM MM_VIDEOS WHERE RECORD_TYP<>5 AND SCR_ID=5";
        ...
        string sql2 = "SELECT * FROM MM_VIDEOS WHERE RECORD_TYP<>5 AND SCR_ID=6";
        ...
        string path1 = "\\acc\\PantryDisplay\\secscrtop\\";
        string path2 = "\\acc\\PantryDisplay\\secscrbtm\\";
        ...
        try
        {
            string TextPath = Server.MapPath("..\\MstMainPan\\scrollingtext.txt");
