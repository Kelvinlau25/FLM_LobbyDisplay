...
public partial class Acc_PantryDisplay_pantry_mainDisplay : System.Web.UI.Page
{
    ...
    {
        string sql = "SELECT * FROM MM_VIDEOS WHERE RECORD_TYP<>5 AND SCR_ID=4";
        ...
        string path1 = "\\acc\\PantryDisplay\\mainscr\\";
