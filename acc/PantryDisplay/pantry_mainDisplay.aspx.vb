...
Partial Class Acc_PantryDisplay_pantry_mainDisplay
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		...
		Dim sql As String = "SELECT * FROM MM_VIDEOS WHERE RECORD_TYP<>5 AND SCR_ID=4"
        Dim dt As New DataTable
        If Not db_connSQLSel(sql, dt) Then
            Exit Sub
        End If
		
		Dim path1 As String = "\acc\PantryDisplay\mainscr\"
		...
		Try    
			Dim TextPath as String = Server.MapPath("..\MstMainPan\scrollingtext.txt")		
