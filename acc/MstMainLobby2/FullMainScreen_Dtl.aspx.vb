...
Partial Class acc_MstMainLobby2_FullMainScreen_Dtl
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        ...
        Else
            ...
            If MyBase.Action = EnumAction.Edit Then
                ...
                lblMainTitle.Text = "Master Maintenance Main Screen Video - TV 2- Edit"
        ...
        Try
                ...
                If fileupload.HasFile Then
                    ...
                    If ext.Equals(".mp4") Then
                        ...
                        If fileSize <= 4294967295 Then
                            ...
                            Dim paths As String = Server.MapPath("~/acc/LobbyDisplay2/mainscr/" + name)
            ...
            If MyBase.Action = EnumAction.Add Then
                ...
                If dt.Rows.Count = 0 Then
                    ...
                    & name & "','" & seek_start & "','" & seek_end & "','" & start_time & "','" & end_time & "','7','1','" & user & "',GETDATE() ,'" & loc & "','" & user & "',GETDATE() ,'" & loc & "')"
