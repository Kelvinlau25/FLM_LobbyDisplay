...
Partial Class acc_MstMainLobby2_Lower2ndScreen_Dtl
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        ...
        Else
            ...
            If MyBase.Action = EnumAction.Edit Then
                ...
                lblMainTitle.Text = "Master Maintenance Second Screen Lower Video - TV 2 - Edit"
            ...
            ElseIf MyBase.Action = EnumAction.Add Then
                lblMainTitle.Text = "Master Maintenance Second Screen Lower Video - Add"
        ...
        Try
                ...
                If FileUpload.HasFile Then
                    ...
                    If ext.Equals(".mp4") Then
                        ...
                        If fileSize <= 4294967295 Then
                            ...
                            Dim paths As String = Server.MapPath("~/acc/LobbyDisplay2/secscrbtm/" + name)
            ...
            If MyBase.Action = EnumAction.Add Then
                ...
                If dt.Rows.Count = 0 Then
                    ...
                    If Double.TryParse(txt_skstart.Text, startValue) Then
                        seek_start = startValue.ToString()
                    Else
                        Library.Root.Control.MessageCenter.ShowAJAXMessageBox(Me.Page, "Seek Start Only Allow Number!")
                        Exit Sub
                    End If

                    If Double.TryParse(txt_skstop.Text, endValue) Then
                        seek_end = endValue.ToString()
                    Else
                        Library.Root.Control.MessageCenter.ShowAJAXMessageBox(Me.Page, "Seek End Only Allow Number!")
                        Exit Sub
                    End If
                    ...
                    & name & "','" & seek_start & "','" & seek_end & "','" & start_time & "','" & end_time & "','9','1','" & user & "',GETDATE() ,'" & loc & "','" & user & "',GETDATE() ,'" & loc & "')"
