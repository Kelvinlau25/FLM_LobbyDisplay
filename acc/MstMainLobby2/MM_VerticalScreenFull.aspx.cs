...
public partial class acc_MstMainLobby2_MM_VerticalScreenFull : System.Web.UI.Page
{
    int clear = 0;
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            {
                var dt = new DataTable();
                string Sql = "SELECT * FROM MM_VIDEOS WHERE RECORD_TYP<>5 AND SCR_ID=7 order by ID_MM_VIDEOS desc";

                var dt2 = new DataTable();
                string Sql2 = "SELECT * FROM MM_VIDEOS WHERE RECORD_TYP<>5 AND SCR_ID=8 order by ID_MM_VIDEOS desc";

                var dt3 = new DataTable();
                string Sql3 = "SELECT * FROM MM_VIDEOS WHERE RECORD_TYP<>5 AND SCR_ID=9 order by ID_MM_VIDEOS desc";
    ...
    {
        Response.Redirect("~/acc/MstMainLobby2/FullMainScreen_Dtl.aspx?action=1");
    }

    protected void Redirect2(object sender, EventArgs e)
    {
        Response.Redirect("~/acc/MstMainLobby2/Upper2ndScreen_Dtl.aspx?action=1");
    }

    protected void Redirect3(object sender, EventArgs e)
    {
        Response.Redirect("~/acc/MstMainLobby2/Lower2ndScreen_Dtl.aspx?action=1");
    }
