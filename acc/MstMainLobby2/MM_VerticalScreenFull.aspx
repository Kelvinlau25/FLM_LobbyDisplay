...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h2><asp:Label ID="lblTitle" runat="server" Text="Master Maintenance Main Screen Video - TV 2"></asp:Label></h2>
  ...
  <asp:Panel ID="pnl1" runat="server">
                   ...
                   <PagerSettings PageButtonCount ="5" Mode="NextPreviousFirstLast" NextPageText ="Next" LastPageText ="Last" FirstPageText ="First" PreviousPageText ="Previous" />
                        <Columns>
                            ...
                            <asp:TemplateField HeaderStyle-Width="79%" HeaderText="Video Files" HeaderStyle-HorizontalAlign="Left">
                                ...
                                <ItemTemplate>
                                <a class="youtube" target="_blank" href="../PopUpLobby2/ImgVideoPreview.aspx?id='<%#Eval("Attach_File")%>'&scr=1"><%#Eval("Attach_File")%></a>
                            </ItemTemplate>
                            </asp:TemplateField>
    ...
    <h2><asp:Label ID="lblTitle2" runat="server" Text="Master Maintenance Second Screen Upper Video - TV 2"></asp:Label></h2>
                   ...
                   <PagerSettings PageButtonCount ="5" Mode="NextPreviousFirstLast" NextPageText ="Next" LastPageText ="Last" FirstPageText ="First" PreviousPageText ="Previous" />
                        <Columns>
                            ...
                            <asp:TemplateField HeaderStyle-Width="79%" HeaderText="Video Files" HeaderStyle-HorizontalAlign="Left">
                                <ItemStyle  HorizontalAlign="Left"></ItemStyle>
                                <ItemTemplate>
                                <a class="youtube" target="_blank" href="../PopUpLobby2/ImgVideoPreview.aspx?ID='<%#Eval("Attach_File")%>'&scr=2"><%#Eval("Attach_File")%></a>
                            </ItemTemplate>
                            </asp:TemplateField>
    ...
    <h2><asp:Label ID="lblTitle3" runat="server" Text="Master Maintenance Second Screen Lower Video - TV 2"></asp:Label></h2>
                   ...
                   <PagerSettings PageButtonCount ="5" Mode="NextPreviousFirstLast" NextPageText ="Next" LastPageText ="Last" FirstPageText ="First" PreviousPageText ="Previous" />
                        <Columns>
                            ...
                            <asp:TemplateField HeaderStyle-Width="79%" HeaderText="Video Files" HeaderStyle-HorizontalAlign="Left">
                                <ItemStyle  HorizontalAlign="Left"></ItemStyle>
                                <ItemTemplate>
                                <a class="youtube" target="_blank" href="../PopUpLobby2/ImgVideoPreview.aspx?ID='<%#Eval("Attach_File")%>'&scr=3"><%#Eval("Attach_File")%></a>
                            </ItemTemplate>
                            </asp:TemplateField>
