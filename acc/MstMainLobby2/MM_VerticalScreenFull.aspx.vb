...
Partial Class acc_MstMainLobby2_MM_VerticalScreenFull
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        ...
        Else
            ...
            If Not IsPostBack Then
                ...
                Dim dt As New Data.DataTable
                Dim Sql As String = "SELECT * FROM MM_VIDEOS WHERE RECORD_TYP<>5 AND SCR_ID=7 order by ID_MM_VIDEOS desc"

                Dim dt2 As New Data.DataTable
                Dim Sql2 As String = "SELECT * FROM MM_VIDEOS WHERE RECORD_TYP<>5 AND SCR_ID=8 order by ID_MM_VIDEOS desc"

                Dim dt3 As New Data.DataTable
                Dim Sql3 As String = "SELECT * FROM MM_VIDEOS WHERE RECORD_TYP<>5 AND SCR_ID=9 order by ID_MM_VIDEOS desc"
