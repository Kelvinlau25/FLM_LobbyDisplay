<%@ Page Language="VB" MasterPageFile="~/master/Main.master" AutoEventWireup="false" CodeFile="MM_VerticalScreenFull.aspx.vb" Inherits="acc_MstMain_MM_VerticalScreenFull" title="Master Maintenance Screen Video" %>
                   ...
                   <PagerSettings PageButtonCount ="5" Mode="NextPreviousFirstLast" NextPageText ="Next" LastPageText ="Last" FirstPageText ="First" PreviousPageText ="Previous" />
                        <Columns>
                            ...
                            <asp:TemplateField HeaderStyle-Width="79%" HeaderText="Video Files" HeaderStyle-HorizontalAlign="Left">
                                ...
                                <ItemTemplate>
                                <a class="youtube" target="_blank" href="../PopUpPan/ImgVideoPreview.aspx?id='<%#Eval("Attach_File")%>'&scr=1"><%#Eval("Attach_File")%></a>
                            </ItemTemplate>
                            </asp:TemplateField>
                   ...
                   <PagerSettings PageButtonCount ="5" Mode="NextPreviousFirstLast" NextPageText ="Next" LastPageText ="Last" FirstPageText ="First" PreviousPageText ="Previous" />
                        <Columns>
                            ...
                            <asp:TemplateField HeaderStyle-Width="79%" HeaderText="Video Files" HeaderStyle-HorizontalAlign="Left">
                                <ItemStyle  HorizontalAlign="Left"></ItemStyle>
                                <ItemTemplate>
                                <a class="youtube" target="_blank" href="../PopUpPan/ImgVideoPreview.aspx?ID='<%#Eval("Attach_File")%>'&scr=2"><%#Eval("Attach_File")%></a>
                            </ItemTemplate>
                            </asp:TemplateField>
                   ...
                   <PagerSettings PageButtonCount ="5" Mode="NextPreviousFirstLast" NextPageText ="Next" LastPageText ="Last" FirstPageText ="First" PreviousPageText ="Previous" />
                        <Columns>
                            ...
                            <asp:TemplateField HeaderStyle-Width="79%" HeaderText="Video Files" HeaderStyle-HorizontalAlign="Left">
                                <ItemStyle  HorizontalAlign="Left"></ItemStyle>
                                <ItemTemplate>
                                <a class="youtube" target="_blank" href="../PopUpPan/ImgVideoPreview.aspx?ID='<%#Eval("Attach_File")%>'&scr=3"><%#Eval("Attach_File")%></a>
                            </ItemTemplate>
                            </asp:TemplateField>
