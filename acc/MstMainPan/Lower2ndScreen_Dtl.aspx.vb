...
Partial Class acc_MstMain_Lower2ndScreen_Dtl
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        ...
        Else
            ...
            If MyBase.Action = EnumAction.Edit Then
                ...
                lblMainTitle.Text = "Master Maintenance Second Screen Lower Video - Edit"
        ...
        Try
                ...
                If fileupload.HasFile Then
                    ...
                    If ext.Equals(".mp4") Then
                        ...
                        If fileSize <= 4294967295 Then
                            ...
                            Dim paths As String = Server.MapPath("~/acc/PantryDisplay/secscrbtm/" + name)
            ...
            If MyBase.Action = EnumAction.Add Then
                ...
                If dt.Rows.Count = 0 Then
                    ...
                    & name & "','" & seek_start & "','" & seek_end & "','" & start_time & "','" & end_time & "','6','1','" & user & "',GETDATE() ,'" & loc & "','" & user & "',GETDATE() ,'" & loc & "')"
