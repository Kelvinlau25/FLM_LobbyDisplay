...
Partial Class acc_MstMain_FullMainScreen_Dtl
        ...
        Try
                ...
                If fileupload.HasFile Then
                    ...
                    If ext.Equals(".mp4") Then
                        ...
                        If fileSize <= 4294967295 Then
                            ...
                            Dim paths As String = Server.MapPath("~/acc/LobbyDisplay/mainscr/" + name)
            ...
            If MyBase.Action = EnumAction.Add Then
                ...
                If dt.Rows.Count = 0 Then
                    ...
                    & name & "','" & seek_start & "','" & seek_end & "','" & start_time & "','" & end_time & "','1','1','" & user & "',GETDATE() ,'" & loc & "','" & user & "',GETDATE() ,'" & loc & "')"
