<%@ Page Language="VB" MasterPageFile="~/master/Main.master" AutoEventWireup="false" CodeFile="Lower2ndScreen_Dtl.aspx.vb" Inherits="acc_MstMain_Lower2ndScreen_Dtl" %>
 ...
 <hr />
    ...
    <control:Error ID="Error1" runat="server" ValidationGroup="Group1"/>
     ...
     <asp:Panel ID="pnlmodify" runat="server">
        ...
        <tr> 
            <td class="style1"><asp:Label ID="Label1" runat="server" Text ="*" CssClass ="styler" /> Start Time: </td>
            <td class="style6">
        ...
        <tr>  
            <td class="style1"><asp:Label ID="Label2" runat="server" Text ="*" CssClass ="styler" /> End Time: </td>
            <td class="style6">
  ...
  <asp:Button ID="btnback" runat="server" PostBackUrl ="~/acc/MstMain/MM_VerticalScreenFull.aspx" Text="Back" CausesValidation ="False"  />
