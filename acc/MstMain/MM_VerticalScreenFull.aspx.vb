...
Partial Class acc_MstMain_MM_VerticalScreenFull
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        ...
        Else
            ...
            If Not IsPostBack Then
                ...
                Dim dt As New Data.DataTable
                Dim Sql As String = "SELECT * FROM MM_VIDEOS WHERE RECORD_TYP<>5 AND SCR_ID=1 order by ID_MM_VIDEOS desc"

                Dim dt2 As New Data.DataTable
                Dim Sql2 As String = "SELECT * FROM MM_VIDEOS WHERE RECORD_TYP<>5 AND SCR_ID=2 order by ID_MM_VIDEOS desc"

                Dim dt3 As New Data.DataTable
                Dim Sql3 As String = "SELECT * FROM MM_VIDEOS WHERE RECORD_TYP<>5 AND SCR_ID=3 order by ID_MM_VIDEOS desc"
    ...
    Protected Sub Redirect(ByVal sender As Object, ByVal e As System.EventArgs)
        Response.Redirect("~/acc/MstMain/FullMainScreen_Dtl.aspx?action=1")
    End Sub

    Protected Sub Redirect2(ByVal sender As Object, ByVal e As System.EventArgs)
        Response.Redirect("~/acc/MstMain/Upper2ndScreen_Dtl.aspx?action=1")
    End Sub

    Protected Sub Redirect3(ByVal sender As Object, ByVal e As System.EventArgs)
        Response.Redirect("~/acc/MstMain/Lower2ndScreen_Dtl.aspx?action=1")
    End Sub
