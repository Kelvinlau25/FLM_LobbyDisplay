...
public partial class acc_MstMain_MM_VerticalScreenFull : System.Web.UI.Page
{
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            {
                var dt = new DataTable();
                string Sql = "SELECT * FROM MM_VIDEOS WHERE RECORD_TYP<>5 AND SCR_ID=1 order by ID_MM_VIDEOS desc";

                var dt2 = new DataTable();
                string Sql2 = "SELECT * FROM MM_VIDEOS WHERE RECORD_TYP<>5 AND SCR_ID=2 order by ID_MM_VIDEOS desc";

                var dt3 = new DataTable();
                string Sql3 = "SELECT * FROM MM_VIDEOS WHERE RECORD_TYP<>5 AND SCR_ID=3 order by ID_MM_VIDEOS desc";
